          ...
          <div className="w-full w-8/12 flex flex-col-reverse md:flex-row">
            <div className="w-full flex flex-col gap-2 items-center justify-center p-6">
              <div className="shadow-custom rounded-xl flex flex-col w-full h-full p-6">
                <div className="direction-rtl flex flex-col gap-4">
                  <div className="flex justify-end flex-row-reverse  items-center gap-1">
                    <h2 className="text-gray-600 text-lg">خرید نسخه چاپی</h2>
                    <BiBookAlt />
                  </div>
                  ...
                  <div className="text-center">
                    <button className="text-[12px] md:text-sm bg-emerald-500 hover:bg-emerald-600 transition duration-200 py-2 px-5 text-white rounded-lg">
                      افزودن به سبد خرید
                    </button>
                  </div>
                </div>
            ...
            <div className="w-full w-8/12 flex flex-col gap-2 items-end justify-evenly">
              <h2 className="text-2xl font-normal">{bookName}</h2>
              <div className="flex flex-col gap-2 direction-rtl">
                <div className="text-[14px] text-slate-700">
                  نویسنده : <span>{bookWriter}</span>
                </div>
                <div className="text-[14px] text-slate-700">
                  مترجم : <span>{bookTranslator}</span>
                </div>
                <div className="text-[14px] text-slate-700">
                  نشر : <span>انتشارات {bookPub}</span>
                </div>
                <div className="text-[14px] text-slate-700">
                  موضوع :{' '}
                  <span>
